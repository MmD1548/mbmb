        ...
        if chat['last_message']['author_object_guid'] in admins:
            ...
            if 'reply_to_message_id' in msg_data.keys():
                ...
                if not msg_data['author_object_guid'] in admins:
                    ...
                    bot.sendMessage(chat['object_guid'], 'کاربر سیکتیر شد @Shibabot👺' , chat['last_message']['message_id'])
                    return True
        return False
    except:
        print('server ban bug')
...
g_usvl = ''
test_usvl = ''
auth = "qfmqglhyhplvmxjrktcnjjpgwjavnphx"
#توکن
bot = Bot(auth)
list_message_seened = []
...
#شروع متون
                            ...
                            if text == 'مشخصات' or text == 'اطلاعات':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], '@shibabot',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'رباته؟😐' or text == 'رباته؟' or text == 'رباته؟😐😂' or text == 'رباته😂😐':
                                ...
                                try:
                                    ...
                                    print('server bug1')
                            if text == 'ممد' or text == 'محمد':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'آگا ممد @Pvi_mmd',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'چنل' or text == 'پشتیبانی':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], '🔹- user support @shibabot 👺\n' + '🔹- user ad Bot @Cr_hosyn & @Pvi_mmd 👹',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'شیبا' or text == 'شیبا بات' or text == 'بات شیبا' or text == 'شیبابات' or text == 'شیباجون' or text == 'شیبا😐😂' or text == 'شیبا😐' or text == 'شیبا😂' or text == 'شیبا😂😐' or text == 'shiba' or text == 'shiba bot' or text == 'شیبا جون':
                                print('message geted and sinned')
                                try:
                            ...
                            if text == 'خرید' or text == 'ربات میخام' or text == 'بات میخام' or text == 'خرید ربات' or text == 'خرید بات':
                                ...
                                try:
                                    ...
                                    print('server bug1')
                            if text == 'حسین' or text == 'حسین ولف' or text == 'سازنده' or text == 'سازندت کیه' or text == 'سازندت کیه؟':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'آگا حسین سازنده و ادمین شیبابات @Cr_hosyn',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == '.' or text == '..':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'نقطه نفرس یتیم😐😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'اخی' or text == 'آخی' or text == 'اوخی' or text == 'اوخ':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'با من بچگانه حرف نزن😐😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == '😂' or text == '😂😂' or text == '😂😂😂' or text == '😂😂😂😂' or text == '😂😂😂😂😂':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'نخند بمولا مسواک گرون میشه😐😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == '🤣' or text == '🤣🤣' or text == '🤣🤣🤣' or text == '🤣🤣🤣🤣' or text == '🤣🤣🤣🤣🤣':
...
#اتمام متون
                            ...
                            if text == 'تست' or text == 'test' or text == '!test' or text == '/test' or text == '/Test' or text == '!Test':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], '@shibabot on',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                                ...
                                try:
                                    ...
                                    if not guid in admins and chat['last_message']['author_object_guid'] in admins:
                                        ...
                                        bot.sendMessage(chat['object_guid'], 'کاربر بهمراه ایدی سیکتیر شد @Shibabot 👺' , chat['last_message']['message_id'])
                                except:
                                    print('ban bug')
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'کاربر اضافه شد @Shibabot 👺' , chat['last_message']['message_id'])                         
                                except:
